...
export class CesiumController {
  constructor() {
    ...
    //   sources : {
    //     positiveX : 'data/cesium-assets/skybox/00h+00.jpg',
    //     negativeX : 'data/cesium-assets/skybox/12h+00.jpg',
    //     positiveY : 'data/cesium-assets/skybox/06h-90.jpg',
    //     negativeY : 'data/cesium-assets/skybox/06h+90.jpg',
    //     positiveZ : 'data/cesium-assets/skybox/06h+00.jpg',
    //     negativeZ : 'data/cesium-assets/skybox/12h+00.jpg'
    //   }
    // });
    ...
    var credit = new Cesium.Credit('<a href="https://deltavrobo.com/" target="_blank"><img src=' + 
                require('Assets/img/site-logo.png') + ' ' + 
                ' class="mr-15" alt="site logo" width="35" height="30" title = "DeltaV Robotics"></img></a>', true);
  ...
  createImageryProvider(imageryProviderName = "Offline") {
    let provider;
    let alpha = 1;
